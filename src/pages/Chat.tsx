...
export default function Chat() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      {/* Header */}
      <motion.header 
        className="bg-navy-900 border-b border-white/10 px-6 py-4"
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Badge count={16} color="blue">
              <Button type="text" className="text-white border-white/20">
                Skills Available
              </Button>
            </Badge>
            <Avatar src="/assets/unnamed.jpg" size="small" />
          </div>
        </div>
      </motion.header>
      ...
      <div className="flex flex-col h-[calc(100vh-80px)]">
                ...
                >
                  <div className={`flex items-start space-x-3 max-w-[80%] ${message.type === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}>
                    <Avatar 
                      ...
                      className={message.type === 'ai' ? 'border-2 border-blue-400' : 'bg-blue-600'}
                    />
              ...
              {isTyping && (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <Avatar src="/assets/unnamed.jpg" className="border-2 border-blue-400" />
          ...
          {showSkillSelector && (
            ...
            >
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 max-w-4xl mx-auto">
                <Title level={5} className="text-white mb-4">Select a Skill</Title>
                
                {Object.entries(skillCategories).map(([category, categorySkills]) => (
                  <div key={category} className="mb-6">
                    <Text className="text-white/80 font-medium mb-3 block">{category}</Text>
                    <Row gutter={[12, 12]}>
                          ...
                          >
                            ...
                            >
                              <div className="text-center">
                                <div className={`text-2xl text-${skill.color}-400 mb-2`}>
                                  {skill.icon}
                                </div>
        ...
        {/* Input Area */}
        <motion.div 
          className="border-t border-white/10 bg-slate-900/50 backdrop-blur-sm p-4"
          initial={{ y: 50, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
            ...
            <div className="flex items-end space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <Space>
                    <Text className="text-white/50 text-xs">16 AI models ready</Text>
                  </Space>
                </div>
              </div>
              ...
              <Button
                ...
                className="h-10 px-6 bg-blue-600 hover:bg-blue-700 border-blue-600"
              >
                Send
              </Button>
            </div>
